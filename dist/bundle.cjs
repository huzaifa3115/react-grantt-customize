...
var Task = /*#__PURE__*/function () {
  ...
  _createClass(Task, [{
    ...
    key: "setDependencies",
    value: function setDependencies(value) {
      this._dependencies = Array.isArray(value) ? value : value.split(",").map(function (d) {
        return d.trim();
      });
    }
  }, {
    ...
    set: function set(value) {
      this._dependencies = Array.isArray(value) ? value : value.split(",").map(function (t) {
        return t.trim();
      }).filter(Boolean);
    }
  }]);
